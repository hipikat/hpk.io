...
--
-- Name: picata_article; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.picata_article (
...
ALTER TABLE public.picata_article OWNER TO wagtail;

--
-- Name: picata_articletype; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.picata_articletype (
    id bigint NOT NULL,
...
ALTER TABLE public.picata_articletype OWNER TO wagtail;

--
-- Name: picata_articletype_id_seq; Type: SEQUENCE; Schema: public; Owner: wagtail
--

ALTER TABLE public.picata_articletype ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.picata_articletype_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: picata_basicpage; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.picata_basicpage (
    page_ptr_id integer NOT NULL,
    content jsonb NOT NULL
);


ALTER TABLE public.picata_basicpage OWNER TO wagtail;

--
-- Name: picata_homepage; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.picata_homepage (
    page_ptr_id integer NOT NULL,
...
ALTER TABLE public.picata_homepage OWNER TO wagtail;

--
-- Name: picata_pagetag; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.picata_pagetag (
    id bigint NOT NULL,
    name character varying(100) NOT NULL,
    slug character varying(100) NOT NULL
);
...
ALTER TABLE public.picata_pagetag OWNER TO wagtail;

--
-- Name: picata_pagetag_id_seq; Type: SEQUENCE; Schema: public; Owner: wagtail
--

ALTER TABLE public.picata_pagetag ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.picata_pagetag_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: picata_pagetagrelation; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.picata_pagetagrelation (
    id bigint NOT NULL,
...
ALTER TABLE public.picata_pagetagrelation OWNER TO wagtail;

--
-- Name: picata_pagetagrelation_id_seq; Type: SEQUENCE; Schema: public; Owner: wagtail
--

ALTER TABLE public.picata_pagetagrelation ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.picata_pagetagrelation_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: picata_postgrouppage; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.picata_postgrouppage (
    page_ptr_id integer NOT NULL,
    intro text NOT NULL
);
...
CREATE TABLE public.picata_socialsettings (
    id bigint NOT NULL,
...
ALTER TABLE public.picata_socialsettings OWNER TO wagtail;

--
-- Name: picata_socialsettings_id_seq; Type: SEQUENCE; Schema: public; Owner: wagtail
--

ALTER TABLE public.picata_socialsettings ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.picata_socialsettings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: picata_splitviewpage; Type: TABLE; Schema: public; Owner: wagtail
--

CREATE TABLE public.picata_splitviewpage (
    page_ptr_id integer NOT NULL,
    content jsonb NOT NULL
);


ALTER TABLE public.picata_splitviewpage OWNER TO wagtail;
...
--
-- Name: picata_article picata_article_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_article
    ADD CONSTRAINT picata_article_pkey PRIMARY KEY (page_ptr_id);


--
-- Name: picata_articletype picata_articletype_name_key; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_articletype
    ADD CONSTRAINT picata_articletype_name_key UNIQUE (name);


--
-- Name: picata_articletype picata_articletype_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_articletype
    ADD CONSTRAINT picata_articletype_pkey PRIMARY KEY (id);


--
-- Name: picata_articletype picata_articletype_slug_key; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_articletype
    ADD CONSTRAINT picata_articletype_slug_key UNIQUE (slug);


--
-- Name: picata_basicpage picata_basicpage_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_basicpage
    ADD CONSTRAINT picata_basicpage_pkey PRIMARY KEY (page_ptr_id);


--
-- Name: picata_homepage picata_homepage_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_homepage
    ADD CONSTRAINT picata_homepage_pkey PRIMARY KEY (page_ptr_id);


--
-- Name: picata_pagetag picata_pagetag_name_key; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_pagetag
    ADD CONSTRAINT picata_pagetag_name_key UNIQUE (name);


--
-- Name: picata_pagetag picata_pagetag_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_pagetag
    ADD CONSTRAINT picata_pagetag_pkey PRIMARY KEY (id);


--
-- Name: picata_pagetag picata_pagetag_slug_key; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_pagetag
    ADD CONSTRAINT picata_pagetag_slug_key UNIQUE (slug);


--
-- Name: picata_pagetagrelation picata_pagetagrelation_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_pagetagrelation
    ADD CONSTRAINT picata_pagetagrelation_pkey PRIMARY KEY (id);


--
-- Name: picata_postgrouppage picata_postgrouppage_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--
...
--
-- Name: picata_socialsettings picata_socialsettings_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_socialsettings
    ADD CONSTRAINT picata_socialsettings_pkey PRIMARY KEY (id);


--
-- Name: picata_socialsettings picata_socialsettings_site_id_key; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_socialsettings
    ADD CONSTRAINT picata_socialsettings_site_id_key UNIQUE (site_id);


--
-- Name: picata_splitviewpage picata_splitviewpage_pkey; Type: CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_splitviewpage
    ADD CONSTRAINT picata_splitviewpage_pkey PRIMARY KEY (page_ptr_id);
...
--
-- Name: picata_article_page_type_id_cd369a0d; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX picata_article_page_type_id_cd369a0d ON public.picata_article USING btree (page_type_id);


--
-- Name: picata_articletype_name_dd10e2e1_like; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX picata_articletype_name_dd10e2e1_like ON public.picata_articletype USING btree (name varchar_pattern_ops);


--
-- Name: picata_articletype_slug_c52d8652_like; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX picata_articletype_slug_c52d8652_like ON public.picata_articletype USING btree (slug varchar_pattern_ops);


--
-- Name: picata_pagetag_name_4e344201_like; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX picata_pagetag_name_4e344201_like ON public.picata_pagetag USING btree (name varchar_pattern_ops);


--
-- Name: picata_pagetag_slug_f46b1530_like; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX picata_pagetag_slug_f46b1530_like ON public.picata_pagetag USING btree (slug varchar_pattern_ops);


--
-- Name: picata_pagetagrelation_content_object_id_8978f449; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX picata_pagetagrelation_content_object_id_8978f449 ON public.picata_pagetagrelation USING btree (content_object_id);


--
-- Name: picata_pagetagrelation_tag_id_08d6f841; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX picata_pagetagrelation_tag_id_08d6f841 ON public.picata_pagetagrelation USING btree (tag_id);


--
-- Name: picata_socialsettings_default_social_image_id_368cc69b; Type: INDEX; Schema: public; Owner: wagtail
--

CREATE INDEX picata_socialsettings_default_social_image_id_368cc69b ON public.picata_socialsettings USING btree (default_social_image_id);
...
--
-- Name: picata_article picata_article_page_ptr_id_8b125ee4_fk_wagtailcore_page_id; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_article
    ADD CONSTRAINT picata_article_page_ptr_id_8b125ee4_fk_wagtailcore_page_id FOREIGN KEY (page_ptr_id) REFERENCES public.wagtailcore_page(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: picata_article picata_article_page_type_id_cd369a0d_fk_picata_articletype_id; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_article
    ADD CONSTRAINT picata_article_page_type_id_cd369a0d_fk_picata_articletype_id FOREIGN KEY (page_type_id) REFERENCES public.picata_articletype(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: picata_basicpage picata_basicpage_page_ptr_id_6469ae2c_fk_wagtailcore_page_id; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_basicpage
    ADD CONSTRAINT picata_basicpage_page_ptr_id_6469ae2c_fk_wagtailcore_page_id FOREIGN KEY (page_ptr_id) REFERENCES public.wagtailcore_page(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: picata_homepage picata_homepage_page_ptr_id_c2b1e97d_fk_wagtailcore_page_id; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_homepage
    ADD CONSTRAINT picata_homepage_page_ptr_id_c2b1e97d_fk_wagtailcore_page_id FOREIGN KEY (page_ptr_id) REFERENCES public.wagtailcore_page(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: picata_pagetagrelation picata_pagetagrelati_content_object_id_8978f449_fk_picata_ar; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_pagetagrelation
    ADD CONSTRAINT picata_pagetagrelati_content_object_id_8978f449_fk_picata_ar FOREIGN KEY (content_object_id) REFERENCES public.picata_article(page_ptr_id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: picata_pagetagrelation picata_pagetagrelation_tag_id_08d6f841_fk_picata_pagetag_id; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_pagetagrelation
    ADD CONSTRAINT picata_pagetagrelation_tag_id_08d6f841_fk_picata_pagetag_id FOREIGN KEY (tag_id) REFERENCES public.picata_pagetag(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: picata_postgrouppage picata_postgrouppage_page_ptr_id_77d53743_fk_wagtailco; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--
...
--
-- Name: picata_socialsettings picata_socialsetting_default_social_image_368cc69b_fk_wagtailim; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_socialsettings
    ADD CONSTRAINT picata_socialsetting_default_social_image_368cc69b_fk_wagtailim FOREIGN KEY (default_social_image_id) REFERENCES public.wagtailimages_image(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: picata_socialsettings picata_socialsettings_site_id_99df0a52_fk_wagtailcore_site_id; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_socialsettings
    ADD CONSTRAINT picata_socialsettings_site_id_99df0a52_fk_wagtailcore_site_id FOREIGN KEY (site_id) REFERENCES public.wagtailcore_site(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: picata_splitviewpage picata_splitviewpage_page_ptr_id_a704b642_fk_wagtailco; Type: FK CONSTRAINT; Schema: public; Owner: wagtail
--

ALTER TABLE ONLY public.picata_splitviewpage
    ADD CONSTRAINT picata_splitviewpage_page_ptr_id_a704b642_fk_wagtailco FOREIGN KEY (page_ptr_id) REFERENCES public.wagtailcore_page(id) DEFERRABLE INITIALLY DEFERRED;
